...
└── wiki/              # 技术文档（一篇文档讲透一个主题）
    ...
    ├── databus-bpm-connector-service-design.md  # BPM Connector 端点 Service 设计（4 端点 schema/基类/取舍）
...
| [wiki/databus-bpm-connector-service-design.md](wiki/databus-bpm-connector-service-design.md) | BPM Connector 端点 Service 设计（4 端点入参/出参 schema、公共基类、老系统取舍、原子化原则） | 1D-P0 BPM 端总线 app + ruoyi-databus | 2026-09-17 |
